...
// // Illustration/anime-themed images for the carousel
// const heroImages = [
...
// export const HomePage: React.FC<HomePageProps> = ({ onGetStarted, onStartGame, onCaseStudies }) => {
//   const handlePrimaryAction = onGetStarted ?? onStartGame;
...
//       {/* Side Flare Gradients (match the orange/warm edge glow) */}
//       <div className="pointer-events-none absolute inset-y-0 left-0 z-0 w-[48%]"
...
//             className="px-6 py-2.5 rounded-full bg-zinc-100 text-zinc-950 font-semibold text-[13px] hover:bg-white transition-all shadow-[0_0_30px_rgba(255,255,255,0.12)] active:scale-95"
//           >
//             Create new room
//           </button>
//           <button
//             onClick={onCaseStudies}
//             className="px-6 py-2.5 rounded-full bg-transparent border border-white/20 text-zinc-300 font-medium text-[13px] hover:bg-white/8 hover:text-white hover:border-white/35 transition-all active:scale-95"
//           >
//             Join existing room
//           </button>
//         </div>
